        ...
        <LadioContainer>
            ...
            <LadioItemWrapper>
                <LadioItem>
                    ...
                    <LadioInput>
                        단일 선택
                        <input type="radio" value="0" {...register('selectionType', { required: true })}  style={{ transform: 'scale(1.3)', marginLeft: '10px' }}/>
                    </LadioInput>
                </LadioItem>
                ...
                <LadioItem>
                    ...
                    <LadioInput>
                        복수 선택
                        <input type="radio" value="1" {...register('selectionType', { required: true })} style={{ transform: 'scale(1.3)', marginLeft: '10px' }} />
                    </LadioInput>
                </LadioItem>
            </LadioItemWrapper>
        </LadioContainer>
